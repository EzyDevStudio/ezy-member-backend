...
import 'package:ezymember_backend/controllers/credit_history_controller.dart';
...
class _CreditHistoryScreenState extends State<CreditHistoryScreen> {
  final _historyController = Get.put(CreditHistoryController(), tag: "credit_history");
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            CustomDataTable<CreditHistoryModel>(
              ratios: CreditHistoryModel.ratios,
              headers: CreditHistoryModel.headers,
              models: List.from(_historyController.histories),
              variables: CreditHistoryModel.variables,
            ),
            CustomPagination(
