...
class SpecialVoucherScreen extends StatefulWidget {
  const SpecialVoucherScreen({super.key});

  @override
  State<SpecialVoucherScreen> createState() => _SpecialVoucherScreenState();
}

class _SpecialVoucherScreenState extends State<SpecialVoucherScreen> {
  final _voucherController = Get.put(VoucherController(), tag: "special_voucher");
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            CustomDataTable<VoucherModel>(
              ratios: VoucherModel.specialRatios,
              headers: VoucherModel.specialHeaders,
              models: List.from(_voucherController.vouchers),
              variables: VoucherModel.specialVariables,
