...
const String fieldSubDealerID = "sub_dealer_id";
...
class BranchModel {
  ...
  factory BranchModel.fromJson(Map<String, dynamic> data) => BranchModel(
    id: data[fieldID] ?? 0,
    subDealerID: data[fieldSubDealerID] ?? "",
    ...
    latitude: (data[fieldLatitude] ?? 0).toDouble(),
    longitude: (data[fieldLongitude] ?? 0).toDouble(),
  );

  static final Map<String, String Function(BranchModel)> fields = {
    Globalization.branchName.tr: (b) => b.branchName,
    Globalization.branchDescription.tr: (b) => b.branchDescription,
    Globalization.contactNumber.tr: (b) => b.contactNumber,
    Globalization.city.tr: (b) => b.city,
    Globalization.state.tr: (b) => b.state,
  };

  static List<int> get ratios => [1, 2, 1, 1, 1];
  static List<String> get headers => fields.keys.toList();
  static List<String Function(BranchModel)> get variables => fields.values.toList();
